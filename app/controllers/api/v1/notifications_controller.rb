module Api
  module V1
    class NotificationsController < ApplicationController
      ...
      # POST /api/v1/update_device_token
      ...
      # POST /api/v1/toggle_notifications
      ...
      def test_notification
        ...
        begin
          ...
          if result[:status] == :ok
            ...
            render json: { error: "Failed to send test notification", details: result[:message] }, status: :unprocessable_entity
          end
